...
Hubdarkweb="raw.githubusercontent.com/fisabiliyusri/Mantap/main/wireguard"
# Link Hosting Kalian Untuk Xray
Hubdarkwebn="raw.githubusercontent.com/fisabiliyusri/Mantap/main/xray"
# Link Hosting Kalian Untuk Ipsec
Hubdarkwebnn="raw.githubusercontent.com/fisabiliyusri/Mantap/main/ipsec"
# Link Hosting Kalian Untuk Backup
Hubdarkwebnnn="raw.githubusercontent.com/fisabiliyusri/Mantap/main/backup"
# Link Hosting Kalian Untuk Websocket
Hubdarkwebnnnn="raw.githubusercontent.com/fisabiliyusri/Mantap/main/websocket"
# Link Hosting Kalian Untuk Ohp
Hubdarkwebnnnnn="raw.githubusercontent.com/fisabiliyusri/Mantap/main/ohp"
...
#install xray
wget https://${Hubdarkwebn}/ins-xray.sh && chmod +x ins-xray.sh && screen -S xray ./ins-xray.sh
#install ssh ovpn
...
#installwg
wget https://${Hubdarkweb}/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install L2TP
wget https://${Hubdarkwebnn}/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://${Hubdarkwebnnn}/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# Websocket
wget https://${Hubdarkwebnnnn}/edu.sh && chmod +x edu.sh && ./edu.sh
# Ohp Server
wget https://${Hubdarkwebnnnnn}/ohp.sh && chmod +x ohp.sh && ./ohp.sh
# Install SlowDNS
